...
public final class UseWarehouse {
	...
	public static void main(final String[] args) {
		/*
		 * Provide a different solution to the previous exercise by implementing two
		 * classes: ComparableProduct and OrderedWarehouse. Classes from the previous
		 * exercise can be extended and reused, but not modified.
		 *
		 ...
		 */
		final Product p1 = new ComparableProduct("Phone", 50);
		final Product p2 = new ComparableProduct("Computer", 100);
		final Product p3 = new ComparableProduct("Tablet", 150);
